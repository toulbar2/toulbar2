...
bool check_file_ext(const string fileName, const string ext) {
	...
	return ((extLen <= fileName.length())
			&& (fileName.substr(fileName.length() - extLen) == ext));
}

enum {
	OPT_verbose = 0, OPT_debug, OPT_dumpWCSP, OPT_HELP, OPT_stdin,
...
CSimpleOpt::SOption g_rgOptions[] = {
		...
		// file extension
		{ OPT_wcsp_ext, (char*) "--wcsp_ext", SO_REQ_SEP }, { OPT_wcspXML_ext,
				(char*) "--wcspXML_ext", SO_REQ_SEP }, { OPT_cfn_ext,
				(char*) "--cfn_ext", SO_REQ_SEP }, { OPT_cfngz_ext,
				(char*) "--cfngz_ext", SO_REQ_SEP }, { OPT_cfnxz_ext,
				(char*) "--cfnxz_ext", SO_REQ_SEP }, { OPT_order_ext,
				(char*) "--order_ext", SO_REQ_SEP }, { OPT_uai_ext,
				(char*) "--uai_ext", SO_REQ_SEP }, { OPT_uaigz_ext,
				(char*) "--uaigz_ext", SO_REQ_SEP }, { OPT_uaixz_ext,
				(char*) "--uaixz_ext", SO_REQ_SEP }, { OPT_uai_log_ext,
				(char*) "--uai_log_ext", SO_REQ_SEP }, { OPT_uaigz_log_ext,
				(char*) "--uaigz_log_ext", SO_REQ_SEP }, { OPT_uaixz_log_ext,
				(char*) "--uaixz_log_ext", SO_REQ_SEP }, { OPT_evid_ext,
				(char*) "--evid_ext", SO_REQ_SEP }, { OPT_map_ext,
				(char*) "--map_ext", SO_REQ_SEP }, { OPT_sol_ext,
				(char*) "--sol_ext", SO_REQ_SEP }, { OPT_bep_ext,
				(char*) "--bep_ext", SO_REQ_SEP }, { OPT_ub_ext,
				(char*) "--ub_ext", SO_REQ_SEP }, { OPT_pre_ext,
				(char*) "--pre_ext", SO_REQ_SEP }, { OPT_wcnf_ext,
				(char*) "--wcnf_ext", SO_REQ_SEP }, { OPT_wcnfgz_ext,
				(char*) "--wcnfgz_ext", SO_REQ_SEP }, { OPT_wcnfxz_ext,
				(char*) "--wcnfxz_ext", SO_REQ_SEP }, { OPT_cnf_ext,
				(char*) "--cnf_ext", SO_REQ_SEP }, { OPT_cnfgz_ext,
				(char*) "--cnfgz_ext", SO_REQ_SEP }, { OPT_cnfxz_ext,
				(char*) "--cnfxz_ext", SO_REQ_SEP }, { OPT_qpbo_ext,
				(char*) "--qpbo_ext", SO_REQ_SEP }, { OPT_qpbogz_ext,
				(char*) "--qpbogz_ext", SO_REQ_SEP }, { OPT_qpboxz_ext,
				(char*) "--qpboxz_ext", SO_REQ_SEP }, { OPT_treedec_ext,
				(char*) "--treedec_ext", SO_REQ_SEP }, { OPT_clusterdec_ext,
				(char*) "--clusterdec_ext", SO_REQ_SEP },
		...
		{ OPT_minProperVarSize, (char*) "-X", SO_REQ_SEP }, {
				...
				OPT_boostingBTD, (char*) "-E", SO_OPT }, { NO_OPT_boostingBTD,
				(char*) "-E:", SO_NONE },
		...
		{ OPT_binaryBranching, (char*) "-b", SO_NONE }, { OPT_binaryBranching,
				(char*) "-binaryBranching", SO_NONE }, { NO_OPT_binaryBranching,
				(char*) "-b:", SO_NONE }, { NO_OPT_binaryBranching,
				(char*) "-no--b", SO_NONE }, { NO_OPT_binaryBranching,
				(char*) "-no--binaryBranching", SO_NONE }, {
		...
		{ OPT_elimDegree, (char*) "-e", SO_OPT }, { NO_OPT_elimDegree,
				(char*) "-e:", SO_NONE }, { OPT_elimDegree_preprocessing,
				(char*) "-p", SO_OPT }, { NO_OPT_elimDegree_preprocessing,
				(char*) "-p:", SO_NONE }, { OPT_costfuncSeparate,
				(char*) "-dec", SO_NONE }, { NO_OPT_costfuncSeparate,
				(char*) "-dec:", SO_NONE }, { OPT_nopre, (char*) "-nopre",
				SO_NONE },
		// vac option
		{ OPT_vac, (char*) "-A", SO_OPT },
		{ NO_OPT_vac, (char*) "-A:", SO_NONE }, { OPT_vacValueHeuristic,
				(char*) "-V", SO_NONE }, { NO_OPT_vacValueHeuristic,
				(char*) "-V:", SO_NONE }, { OPT_costThreshold, (char*) "-T",
				SO_REQ_SEP },
		{ OPT_costThresholdPre, (char*) "-P", SO_REQ_SEP }, {
				OPT_costMultiplier, (char*) "-C", SO_REQ_SEP }, { OPT_deltaUb,
				(char*) "-agap", SO_REQ_SEP }, { NO_OPT_trws, (char*) "-trws:",
				SO_NONE }, { OPT_trwsAccuracy, (char*) "-trws", SO_OPT }, {
				...
				OPT_trwsNIterNoChange, (char*) "--trws-n-iters-no-change",
				SO_REQ_SEP }, { OPT_trwsNIterComputeUb,
				(char*) "--trws-n-iters-compute-ub", SO_REQ_SEP },
		...
		{ OPT_QueueComplexity, (char*) "-o", SO_NONE }, { OPT_MSTDAC,
				(char*) "-mst", SO_NONE }, { NO_OPT_MSTDAC, (char*) "-mst:",
				SO_NONE }, { OPT_DEE, (char*) "-dee", SO_OPT }, { NO_OPT_DEE,
				(char*) "-dee:", SO_OPT }, { OPT_lds, (char*) "-l", SO_OPT }, {
				NO_OPT_lds, (char*) "-l:", SO_NONE }, { OPT_restart,
				(char*) "-L", SO_OPT },
		{ NO_OPT_restart, (char*) "-L:", SO_NONE }, { OPT_hbfs, (char*) "-hbfs",
				SO_OPT }, { OPT_hbfs, (char*) "-bfs", SO_OPT }, {
				OPT_hbfs_node_dump, (char*) "-hbfs_nd", SO_OPT }, // flag for dump node limit
		{ OPT_EPS, (char*) "-eps", SO_NONE }, // flag for dump node limit
		{ NO_OPT_hbfs, (char*) "-hbfs:", SO_NONE }, { NO_OPT_hbfs,
				(char*) "-bfs:", SO_NONE }, { OPT_open, (char*) "-open",
				SO_REQ_SEP }, { OPT_localsearch, (char*) "-i", SO_OPT }, // incop option default or string for narycsp argument
		{ OPT_EDAC, (char*) "-k", SO_REQ_SEP }, { OPT_ub, (char*) "-ub",
				SO_REQ_SEP }, // init upper bound in cli
		// MENDELSOFT
		...
		// random generator
		{ OPT_seed, (char*) "-seed", SO_REQ_SEP }, { OPT_random,
				(char*) "-random", SO_REQ_SEP }, // init upper bound in cli

		// VNS Methods
#ifdef BOOST
		{ OPT_VNS_search, (char*) "-vns", SO_NONE }, { OPT_VNS_search,
				(char*) "--vns", SO_NONE }, { OPT_VNS_search, (char*) "-dgvns",
				SO_NONE }, { OPT_VNS_search, (char*) "--dgvns", SO_NONE },
#ifdef OPENMPI
...
#endif
		{ OPT_TREEDEC_search, (char*) "--treedec", SO_NONE }, { OPT_decfile,
				(char*) "--decfile", SO_REQ_SEP }, { OPT_vns_output,
				(char*) "--foutput", SO_REQ_SEP }, { OPT_vns_sol_init,
				(char*) "-vnsini", SO_REQ_SEP }, { OPT_vns_sol_init,
				(char*) "-ldsini", SO_REQ_SEP }, { OPT_vns_sol_init,
				(char*) "--solution-init", SO_REQ_SEP }, { OPT_lds_min,
				(char*) "-ldsmin", SO_REQ_SEP }, { OPT_lds_max,
				(char*) "-ldsmax", SO_REQ_SEP }, { OPT_lds_inc,
				(char*) "-ldsinc", SO_REQ_SEP }, { OPT_k_min, (char*) "-kmin",
				SO_REQ_SEP }, { OPT_k_min, (char*) "--kinit", SO_REQ_SEP }, {
				OPT_k_max, (char*) "-kmax", SO_REQ_SEP }, { OPT_k_max,
				(char*) "--kmax", SO_REQ_SEP }, { OPT_k_inc, (char*) "-kinc",
				SO_REQ_SEP },
		//    { OPT_vns_var_heur, (char*) "--variable-heuristic", SO_REQ_SEP },
		{ OPT_neighbor_change, (char*) "--strategy", SO_NONE }, {
				OPT_neighbor_synch, (char*) "--synch", SO_NONE }, { OPT_optimum,
				(char*) "-best", SO_REQ_SEP }, { OPT_optimum, (char*) "--best",
				SO_REQ_SEP },
#endif
		SO_END_OF_OPTIONS };
...
// get the number of arguments if necessary
	if (nMultiArgs == -1) {
		...
		if (!rgpszArg) {
			_tprintf(
					_T(
							"%s: '%s' (missing argument or please use --help to get command line help)\n \n"),
		...
		cout << endl;
		cout << nMultiArgs
				<< "Alleles probability will be read from command line "
				<< endl;
	}
...
// get the arguments to follow
	...
	if (nMultiBackup < 0) {
		...
		if (ToulBar2::verbose >= 0) {
			for (unsigned int x = 0; x <= sizeof(ToulBar2::allelefreqdistrib);
					x++)
				cout << "Allele prob used " << x << "="
						<< ToulBar2::allelefreqdistrib[x] << endl;
		}
...
void help_msg(char* toulbar2filename) {
	...
	cout
			...
			<< endl;
#ifdef BOOST
	cout << "   *.cfn : Cost Function Network format (see toulbar2 web site)"
			<< endl;
#endif
...
#ifdef BOOST
	cout
			<< "Note: cfn, cnf, LG, qpbo, uai, wcnf, wcsp formats can be read in gzip'd or xz compressed format, e.g., toulbar2 problem.cfn.xz"
			<< endl;
#endif
	cout
	...
	cout << "   -ub=[decimal] : initial problem upperbound (default value is "
			<< MAX_COST << ")" << endl;
	cout
			<< "   -agap=[decimal] : stop search if the absolute optimality gap reduces below the given value (provides guaranteed approximation)"
			<< endl;
	...
	cout
			...
			<< endl;
	cout
			<< "   -precision=[integer] defines the number of digits that should be representable on probabilities in uai/pre files (default value is "
			<< ToulBar2::resolution << ")" << endl;
	cout
			<< "   -qpmult=[double] defines coefficient multiplier for quadratic terms (default value is "
			<< ToulBar2::qpboQuadraticCoefMultiplier << ")" << endl;
#else
...
#endif
	cout
			<< "   -seed=[integer] : random seed non-negative value or use current time if a negative value is given (default value is "
			<< ToulBar2::seed << ")" << endl;
	cout
			<< "   --stdin=[format] : read file from pipe ; e.g., cat example.wcsp | toulbar2 --stdin=wcsp"
			<< endl;
	cout
			<< "   -var=[integer] : searches by branching only on the first -the given value- decision variables, assuming the remaining variables are intermediate variables completely assigned by the decision variables (use a zero if all variables are decision variables) (default value is "
			<< ToulBar2::nbDecisionVars << ")" << endl;
	cout
			<< "   -b : searches using binary branching always instead of binary branching for interval domains and n-ary branching for enumerated domains";
	...
	cout << endl;
	cout
			<< "   -c : searches using binary branching with last conflict backjumping variable ordering heuristic";
	if (ToulBar2::lastConflict)
		cout << " (default option)";
	cout << endl;
	cout
			<< "   -q=[integer] : weighted degree variable ordering heuristic if the number of cost functions is less than the given value (default value is "
			<< ToulBar2::weightedDegree << ")" << endl;
	cout
			<< "   -m=[integer] : variable ordering heuristic based on mean (m=1) or median (m=2) costs (in conjunction with weighted degree heuristic -q) (default value is "
			<< ToulBar2::weightedTightness << ")" << endl;
	cout
			<< "   -d=[integer] : searches using dichotomic branching (d=1 splitting in the middle of domain range, d=2 splitting in the middle of sorted unary costs) instead of binary branching when current domain size is strictly greater than "
			<< ToulBar2::dichotomicBranchingSize << " (default value is "
			<< ToulBar2::dichotomicBranching << ")" << endl;
	cout
	...
	cout << endl;
	cout
			<< "   -e=[integer] : boosting search with variable elimination of small degree (less than or equal to 3) (default value is "
			<< ToulBar2::elimDegree << ")" << endl;
	cout
			<< "   -p=[integer] : preprocessing only: general variable elimination of degree less than or equal to the given value (default value is "
	...
	cout << endl;
	cout
			<< "   -f=[integer] : preprocessing only: variable elimination of functional (f=1) (resp. bijective (f=2)) variables (default value is "
			<< ToulBar2::preprocessFunctional << ")" << endl;
	cout
			<< "   -dec : preprocessing only: pairwise decomposition of cost functions with arity >=3 into smaller arity cost functions";
	if (ToulBar2::costfuncSeparate)
		cout << " (default option)";
	cout << endl;
	cout
			<< "   -n=[integer] : preprocessing only: projects n-ary cost functions on all binary cost functions if n is lower than the given value (default value is "
			<< ToulBar2::preprocessNary << ")" << endl;
#ifdef BOOST
	...
	cout << endl;
	cout
			<< "   -k=[integer] : soft local consistency level (NC with Strong NIC for global cost functions=0, (G)AC=1, D(G)AC=2, FD(G)AC=3, (weak) ED(G)AC=4) (default value is "
			<< ToulBar2::LcLevel << ")" << endl;
	cout
			<< "   -dee=[integer] : restricted dead-end elimination (value pruning by dominance rule from EAC value (dee>=1 and dee<=3)) and soft neighborhood substitutability (in preprocessing (dee=2 or dee=4) or during search (dee=3)) (default value is "
			<< ToulBar2::DEE << ")" << endl;
	cout
			<< "   -l=[integer] : limited discrepancy search, use a negative value to stop the search after the given absolute number of discrepancies has been explored (discrepancy bound = "
			<< maxdiscrepancy << " by default)";
	if (ToulBar2::lds)
		cout << " (default option)";
	cout << endl;
	cout
			<< "   -L=[integer] : randomized (quasi-random variable ordering) search with restart (maximum number of nodes/VNS restarts = "
			<< maxrestarts << " by default)";
	...
	cout
			...
			<< endl;
	cout << "       string parameter is optional, using \"" << Incop_cmd
			<< "\" by default with the following meaning:" << endl;
	cout
	...
	cout
			<< " (usage for parallel version: \"mpirun -n [NbOfProcess] toulbar2 -vns problem.wcsp\")";
#endif
	cout << endl;
	cout
			<< "   -vnsini=[integer] : initial solution for VNS-like methods found (-1) at random, (-2) min domain values, (-3) max domain values, (-4) first solution found by a complete method, (k=0 or more) tree search with k discrepancy max ("
			<< ToulBar2::vnsInitSol << " by default)" << endl;
	cout << "   -ldsmin=[integer] : minimum discrepancy for VNS-like methods ("
			<< ToulBar2::vnsLDSmin << " by default)" << endl;
	cout
			...
			<< endl;
	cout
			<< "   -ldsinc=[integer] : discrepancy increment strategy for VNS-like methods using (1) Add1, (2) Mult2, (3) Luby operator ("
			<< ToulBar2::vnsLDSinc << " by default)" << endl;
	cout
			<< "   -kmin=[integer] : minimum neighborhood size for VNS-like methods ("
			<< ToulBar2::vnsKmin << " by default)" << endl;
	cout
			<< "   -kmax=[integer] : maximum neighborhood size for VNS-like methods (number of problem variables by default)"
			<< endl;
	cout
			<< "   -kinc=[integer] : neighborhood size increment strategy for VNS-like methods using (1) Add1, (2) Mult2, (3) Luby operator (4) Add1/Jump ("
			<< ToulBar2::vnsKinc << " by default)" << endl;
	cout
			<< "   -best=[integer] : stop VNS-like methods if a better solution is found (default value is "
			<< ToulBar2::vnsOptimum << ")" << endl;
	cout << endl;
#endif
	cout
			<< "   -z=[filename] : saves problem in wcsp format in filename (or \"problem.wcsp\"  if no parameter is given)"
			<< endl;
	cout
	...
	cout << endl;
	cout
			<< "   -M=[integer] : preprocessing only: Min Sum Diffusion algorithm (default number of iterations is "
			<< ToulBar2::minsumDiffusion << ")" << endl;
	cout
			<< "   -A=[integer] : enforces VAC at each search node with a search depth less than a given value (default value is "
			<< ToulBar2::vac << ")" << endl;
	cout << "   -T=[decimal] : threshold cost value for VAC (default value is "
			<< ToulBar2::costThreshold << ")" << endl;
	cout
			<< "   -P=[decimal] : threshold cost value for VAC during the preprocessing phase (default value is "
			<< ToulBar2::costThresholdPre << ")" << endl;
	cout
			<< "   -C=[float] : multiplies all costs internally by this number when loading the problem (default value is "
			<< ToulBar2::costMultiplier << ")" << endl;
	cout
	...
	cout << endl;
	cout
			<< "   -trws=[float] : enforces TRW-S in preprocessing until a given precision is reached (default value is "
			<< ToulBar2::trwsAccuracy << ")" << endl;
	cout << "   --trws-order : replaces DAC order by Kolmogorov's TRW-S order";
	if (ToulBar2::trwsOrder)
		cout << " (default option)";
	cout << endl;
	cout
			<< "   --trws-n-iters=[integer] : enforce at most N iterations of TRW-S (default value is "
			<< ToulBar2::trwsNIter << ")" << endl;
	cout
			<< "   --trws-n-iters-no-change=[integer] : stop TRW-S when N iterations did not change the lower bound up the given precision (default value is "
			<< ToulBar2::trwsNIterNoChange << ", -1=never)" << endl;
	cout
			<< "   --trws-n-iters-compute-ub=[integer] : compute UB every N steps in TRW-S (default value is "
			<< ToulBar2::trwsNIterComputeUb << ")" << endl;
	cout << endl;

	cout
			<< "   -B=[integer] : (0) DFBB, (1) BTD, (2) RDS-BTD, (3) RDS-BTD with path decomposition instead of tree decomposition (default value is "
	...
	cout
			...
			<< endl;
	cout << "                           (-" << MAX_CARD
			<< ") maximum cardinality search ordering, (-" << MIN_DEGREE
			<< ") minimum degree ordering, (-" << MIN_FILL
			<< ") minimum fill-in ordering," << endl;
	cout << "                           (-" << ELIM_MST
			<< ") maximum spanning tree ordering (see -mst), (-"
			<< CUTHILL_MCKEE << ") reverse Cuthill-Mckee ordering, (-"
			<< APPROX_MIN_DEGREE << ") approximate minimum degree ordering,"
			<< endl;
	cout << "                           (-" << ELIM_FILE_ORDER
			<< ") default file ordering (the same if this option is missing, i.e. use the variable order in which variables appear in the problem file)"
			<< endl;
#endif
	cout
			...
			<< endl;
	cout
			<< "                (use options \"-B=3 -j=1 -svo -k=1\" for pure RDS, use value 0 for no splitting) (default value is "
			<< ToulBar2::splitClusterMaxSize << ")" << endl;
	cout
			<< "   -r=[integer] : limit on maximum cluster separator size (merge cluster with its father otherwise, use a negative value for no limit) (default value is "
			<< ToulBar2::maxSeparatorSize << ")" << endl;
	cout
			<< "   -X=[integer] : limit on minimum number of proper variables in a cluster (merge cluster with its father otherwise, use a zero for no limit) (default value is "
			<< ToulBar2::minProperVarSize << ")" << endl;
	cout
			<< "   -E=[float] : merges leaf clusters with their fathers if small local treewidth (in conjunction with option \"-e\" and positive threshold value) or ratio of number of separator variables by number of cluster variables above a given threshold (in conjunction with option \"-vns\") (default value is "
			<< ToulBar2::boostingBTD << ")" << endl;
	cout << "   -R=[integer] : choice for a specific root cluster number"
			<< endl;
	cout
	...
	cout
			...
			<< endl;
	cout
			<< "   -epsilon=[float] : approximation factor for computing the partition function (greater than 1, default value is "
			<< Exp(-ToulBar2::logepsilon) << ")" << endl;
	cout << endl;
	cout
			<< "   -hbfs=[integer] : hybrid best-first search, restarting from the root after a given number of backtracks (default value is "
			<< hbfsgloballimit << ")" << endl;
	cout
			<< "   -open=[integer] : hybrid best-first search limit on the number of open nodes (default value is "
			<< ToulBar2::hbfsOpenNodeLimit << ")" << endl;
	cout
			<< "   -eps : activate embarrassingly parallel hybrid best-first search."
			<< endl;
	cout << "---------------------------" << endl;
	cout
...
//default file extension : can be enforced using --foo_ext option in command line
	...
	assert(
			cout
					<< "Warning! toulbar2 was compiled in debug mode and it can be very slow..."
					<< endl);
	if (ToulBar2::verbose >= 0)
		cout << "c " << CurrentBinaryPath << "toulbar2" << "  version : "
				<< ToulBar2::version
				<< ", copyright (c) 2006-2019, toulbar2 team" << endl;
	...
	while (args.Next()) {
		...
		if (args.LastError() == SO_SUCCESS) {
			...
			if (strstr(args.OptionText(), "_ext")) {
				...
				force_extension.erase(force_extension.begin(),
						force_extension.begin() + 2);
				if (ToulBar2::debug)
					cout << "Old extension "
							<< file_extension_map[force_extension] << " --> ";
				//			cout << " extension " << force_extension << " forced with " << args.OptionArg() << endl;
				file_extension_map[force_extension] = args.OptionArg();

				if (ToulBar2::debug)
					cout << " New extension "
							<< file_extension_map[force_extension] << endl;
			}
			...
			if (args.OptionId() == OPT_decfile) {
				...
				if (!decfile) {
					cerr << "File " << ToulBar2::clusterFile << " not found!"
							<< endl;
					exit(EXIT_FAILURE);
				}
			}
			...
			if (args.OptionId() == OPT_vns_sol_init) {
				if (args.OptionArg() != NULL)
					ToulBar2::vnsInitSol =
							static_cast<VNSSolutionInitMethod>(atoi(
									args.OptionArg()));
			}
			...
			if (args.OptionId() == OPT_lds_inc) {
				if (args.OptionArg() != NULL)
					ToulBar2::vnsLDSinc = static_cast<VNSInc>(atoi(
							args.OptionArg()));
			}
			...
			if (args.OptionId() == OPT_k_inc) {
				if (args.OptionArg() != NULL)
					ToulBar2::vnsKinc = static_cast<VNSInc>(atoi(
							args.OptionArg()));
			}
			...
			if (args.OptionId() == OPT_stdin) {
				...
				if (ToulBar2::stdin_format.length() == 0) {
					...
					if (ToulBar2::stdin_format.compare("bep") == 0
							|| ToulBar2::stdin_format.compare("map") == 0
							|| ToulBar2::stdin_format.compare("pre") == 0) {
						cerr << "Error: cannot read this "
								<< ToulBar2::stdin_format
								<< " format using stdin option!" << endl;
						exit(EXIT_FAILURE);
					}
				}
			...
			if (args.OptionId() == OPT_varOrder) {
				...
				if (varElimOrder >= 0) {
					...
					if (ToulBar2::debug)
						cout << "variable order read from file "
								<< args.OptionArg() << endl;
				} else {
			...
			if (args.OptionId() == OPT_problemsaved_filename) {
				...
				if (ToulBar2::debug)
					cout << "saved problem into file "
							<< ToulBar2::problemsaved_filename << endl;
			}
			...
			if (args.OptionId() == OPT_PARTIAL_ASSIGNMENT) {
				if (args.OptionArg() != NULL) {
					...
					if (ToulBar2::debug)
						cout << "partial assignment to be checked ..."
								<< certificateString << endl;
				} else {
					certificate = true;
					certificateFilename = (char*) "sol";
					if (ToulBar2::debug)
						cout << "certificate of solution read in file: ./"
								<< certificateFilename << endl;
				}
			...
			if (args.OptionId()
			== OPT_weightedDegree and args.OptionArg() != NULL) {
			...
			if (args.OptionId() == NO_OPT_elimDegree) {
				...
				if (ToulBar2::debug)
					...
					== OPT_elimDegree and args.OptionArg() != NULL) {
				int ndegree = -1;
			...
			if (args.OptionId() == OPT_elimDegree_preprocessing) {
				...
				if (ToulBar2::debug)
					cout << "elimDegree_preprocessing ON: "
							<< ToulBar2::elimDegree_preprocessing << endl;

			} else if (args.OptionId() == NO_OPT_elimDegree_preprocessing) {
				ToulBar2::elimDegree_preprocessing = -1;
				if (ToulBar2::debug)
					cout << "elimDegree_preprocessing OFF: "
							<< ToulBar2::elimDegree_preprocessing << endl;
			}
			...
			if (args.OptionId() == OPT_preprocessTernary) {
				...
				if (ToulBar2::debug)
					cout
							<< "preprocess triangles of binary cost functions into ternary cost functions OFF"
							<< endl;
			...
			if (args.OptionId() == OPT_preprocessFunctional) {
				...
				if (ToulBar2::debug)
					cout << "elimination of functional variables ON "
							<< ToulBar2::preprocessFunctional << endl;
			...
			if (args.OptionId() == OPT_preprocessNary) {
				...
				if (ToulBar2::debug)
					cout << "preproject cost functions with arity lower than "
							<< ToulBar2::preprocessNary << " ON" << endl;
			...
			if (args.OptionId() == OPT_lds) {
				...
				if (ToulBar2::debug)
					cout << "LDS ON #iter = " << ToulBar2::lds << comment
							<< endl;
			...
			if (args.OptionId() == OPT_restart) {
				...
				if (ToulBar2::debug)
					cout << "restart ON #iter = " << ToulBar2::restart
							<< comment << endl;
			...
			if (args.OptionId() == OPT_hbfs) {
				...
				if (ToulBar2::debug)
					cout << "hybrid BFS ON with global backtrack limit = "
							<< ToulBar2::hbfsGlobalLimit << comment << endl;
...
// david's option
			if (args.OptionId() == OPT_hbfs_node_dump) {
				if (args.OptionArg() == NULL) {
					...
					cout << "david : my new option defined with kad "
							<< ToulBar2::hbfs_node_dump << endl;
				}
			}
//kad
			if (args.OptionId() == OPT_EPS) {
				ToulBar2::EPS = true;
				cout << "HBFS  Embarrassingly Parallel Search activated. "
						<< endl;
			}
...
// fin nouvelle option
			if (args.OptionId() == OPT_open) {
				...
				if (ToulBar2::hbfsGlobalLimit == 0)
					ToulBar2::hbfsGlobalLimit = hbfsgloballimit;
				ToulBar2::hbfs = 1; // initial value to perform a greedy search exploration before visiting a new open search node
				cout << "hybrid BFS ON with open node limit = "
						<< ToulBar2::hbfsOpenNodeLimit << endl;
			}
			...
			if (args.OptionId() == MENDEL_OPT_genotypingErrorRate) {
				if (args.OptionArg() != NULL) {
					...
					ToulBar2::errorg = f;
					if (ToulBar2::debug)
						cout << "New assignment for genotyping Error Rate = "
								<< ToulBar2::errorg << endl;
				}
			}
			...
			if (args.OptionId() == MENDEL_OPT_resolution) {
				if (args.OptionArg() != NULL) {
					...
					if (ToulBar2::debug)
						cout << "New assignment for precision = "
								<< ToulBar2::resolution << endl;
				}
			}
			...
			if (args.OptionId() == OPT_pedigree_by_MPE) {
				...
				if (ToulBar2::verbose >= 1) {
					cout << endl;
					cout << "genotypingErrorRate = " << ToulBar2::errorg
							<< " (default value)" << endl;
					cout << "resolution = " << ToulBar2::resolution
							<< " (default value)" << endl;
					cout << endl;
				}
			}

			if (args.OptionId() == MENDEL_OPT_EQUAL_FREQ
					&& ToulBar2::bayesian) {

				ToulBar2::foundersprob_class = 0;
				if (ToulBar2::debug)
					cout << "equal frequencies used ( default mode)"
							<< ToulBar2::foundersprob_class << endl;

			} else if (args.OptionId() == MENDEL_OPT_ESTIMAT_FREQ
					&& ToulBar2::bayesian) {
				ToulBar2::foundersprob_class = 1;
				if (ToulBar2::debug)
					cout
							<< " => prob depending on the frequencies found in the current pedigree probleme used"
							<< endl;

			} else if (args.OptionId() == MENDEL_OPT_ALLOCATE_FREQ
					&& ToulBar2::bayesian) {
				if (ToulBar2::debug)
					cout << " => prob frequencies read from command line"
							<< endl;
			...
			if (args.OptionId() == OPT_dumpWCSP) {
				...
				if (ToulBar2::dumpWCSP <= 1) {
					if (ToulBar2::debug)
						cout
								<< "original problem dump in problem.wcsp (see also Graphviz and degree distribution)"
								<< endl;
				} else {
					if (ToulBar2::debug)
						cout
								<< "dump after preprocessing in problem.wcsp (see also Graphviz and degree distribution)"
								<< endl;
				}
			}
			...
			if (args.OptionId() == OPT_epsilon) {
				if (args.OptionArg() != NULL) {
					...
					if (ToulBar2::debug)
						cout << "New assignment for epsilon = "
								<< Exp(-ToulBar2::logepsilon) << endl;
				}
			}
			...
			_tprintf(
					_T(
							"invalid Option :%s or Invalid argument: %s \n please check help using --help option "),
					args.OptionText(),
...
// command line and the expanded file names
	if (ToulBar2::verbose > 0) {
		cout << "cmd line parsing ---> " << glob.FileCount()
				<< " Filename(s) found in command line" << endl;
	}
	string strfile;
	string strext;
	...
	if (random_desc == NULL) {
		...
		for (int n = 0;
				n
						< glob.FileCount()
								+ ((ToulBar2::stdin_format.size() > 0) ? 1 : 0);
				++n) {
			string problem = "";
			if (n < glob.FileCount())
				problem = to_string(glob.File(n));

			if (check_file_ext(problem, file_extension_map["wcsp_ext"])
					|| ToulBar2::stdin_format.compare("wcsp") == 0) {
				if (ToulBar2::verbose >= 0)
			...
			if (check_file_ext(problem, file_extension_map["wcspxz_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout << "loading xz compressed wcsp file: " << problem
							<< endl;
				strext = ".wcsp.xz";
				strfile = problem;
				ToulBar2::xz = true;
			...
			// CFN file
			if (check_file_ext(problem, file_extension_map["cfn_ext"])
					|| ToulBar2::stdin_format.compare("cfn") == 0) {
				if (ToulBar2::verbose >= 0)
			...
			if (check_file_ext(problem, file_extension_map["cfnxz_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout << "loading xz compressed cfn file: " << problem
							<< endl;
				strext = ".cfn.xz";
				strfile = problem;
				ToulBar2::cfn = true;
			...
			// uai  file
			if (check_file_ext(problem, file_extension_map["uai_ext"])
					|| ToulBar2::stdin_format.compare("uai") == 0) {
				strfile = problem;
				strext = ".uai";
				if (ToulBar2::verbose >= 0)
			...
			if (check_file_ext(problem, file_extension_map["uaixz_ext"])) {
				...
				strext = ".uai.xz";
				if (ToulBar2::verbose >= 0)
					cout << "loading xz compressed uai file:  " << problem
							<< endl;
				ToulBar2::uai = 1;
				ToulBar2::bayesian = true;
				ToulBar2::xz = true;
			...
			// uai log file
			if (check_file_ext(problem, file_extension_map["uai_log_ext"])
					|| ToulBar2::stdin_format.compare("LG") == 0) {
				strfile = problem;
				strext = ".LG";
				if (ToulBar2::verbose >= 0)
			...
			if (check_file_ext(problem, file_extension_map["uaixz_log_ext"])) {
				...
				strext = ".LG.xz";
				if (ToulBar2::verbose >= 0)
					cout << "loading xz compressed uai log file:  " << problem
							<< endl;
				ToulBar2::uai = 2;
				ToulBar2::bayesian = true;
				ToulBar2::xz = true;
			...
			// wcnf or cnf file
			if (check_file_ext(problem, file_extension_map["wcnf_ext"])
					|| ToulBar2::stdin_format.compare("wcnf") == 0
					|| ToulBar2::stdin_format.compare("cnf") == 0) {
				if (ToulBar2::verbose >= 0)
			...
			if (check_file_ext(problem, file_extension_map["wcnfgz_ext"])) {
				...
				strfile = problem;
				ToulBar2::gz = true;
			} else if (check_file_ext(problem,
					file_extension_map["cnfgz_ext"])) {
				if (ToulBar2::verbose >= 0)
			...
			if (check_file_ext(problem, file_extension_map["wcnfxz_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout << "loading xz compressed wcnf file:" << problem
							<< endl;
				ToulBar2::wcnf = true;
				strext = ".wcnf.xz";
				strfile = problem;
				ToulBar2::xz = true;
					...
					file_extension_map["cnfxz_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout << "loading xz compressed cnf file:" << problem
							<< endl;
				ToulBar2::wcnf = true;
				strext = ".cnf.xz";
				strfile = problem;
			...
			if (check_file_ext(problem, file_extension_map["qpbo_ext"])
					|| ToulBar2::stdin_format.compare("qpbo") == 0) {
				if (ToulBar2::verbose >= 0)
					cout
							<< "loading quadratic pseudo-Boolean optimization file:"
							<< problem << endl;
				ToulBar2::qpbo = true;
				strext = ".qpbo";
				strfile = problem;
			...
			if (check_file_ext(problem, file_extension_map["qpbogz_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout
							<< "loading gzip'd quadratic pseudo-Boolean optimization file:"
							<< problem << endl;
				ToulBar2::qpbo = true;
				strext = ".qpbo.gz";
				strfile = problem;
			...
			if (check_file_ext(problem, file_extension_map["qpboxz_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout
							<< "loading xz compressed quadratic pseudo-Boolean optimization file:"
							<< problem << endl;
				ToulBar2::qpbo = true;
				strext = ".qpbo.xz";
				strfile = problem;
			...
			if (check_file_ext(problem, file_extension_map["ub_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout << "loading upper bound from file: " << problem
							<< endl;
				string ubstring = read_UB(problem.c_str());
				if (ubstring.c_str() != NULL) {
					if (ToulBar2::externalUB.length() != 0) {
						cerr
								<< "Error: cannot set upper bound from command line and file simultaneously."
								<< endl;
						exit(EXIT_FAILURE);
					} else {
			...
			if (check_file_ext(problem, file_extension_map["order_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout << "loading variable order in file: " << problem
							<< endl;
				//				if (ToulBar2::varOrder) delete [] ToulBar2::varOrder;
			...
			if (check_file_ext(problem, file_extension_map["treedec_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout << "loading tree decomposition in file: " << problem
							<< endl;
				//              if (ToulBar2::varOrder) delete [] ToulBar2::varOrder;
				ToulBar2::varOrder = new char[problem.length() + 1];
				sprintf(ToulBar2::varOrder, "%s", problem.c_str());
				if (!WCSP::isAlreadyTreeDec(ToulBar2::varOrder)) {
					cerr
							<< "Input tree decomposition file is not valid! (first cluster must be a root, i.e., parentID=-1)"
							<< endl;
					exit(EXIT_FAILURE);
				}
			...
			if (check_file_ext(problem, file_extension_map["clusterdec_ext"])) {
				if (ToulBar2::verbose >= 0)
					cout << "loading cluster decomposition in file: " << problem
							<< endl;
			...
			if (check_file_ext(problem, file_extension_map["sol_ext"])) {
				if (certificateString && strcmp(certificateString, "") != 0) {
					cerr
							<< "\n COMMAND LINE ERROR cannot read a solution if a partial assignment is given in the command line using -x= argument "
							<< endl;
					exit(-1);
				}
				if (ToulBar2::verbose >= 0)
...
/////////////////////////////////////////
	...
	if (ToulBar2::verifyOpt && (!certificate || certificateFilename == NULL)) {
		cerr
				<< "Error: no optimal solution file given. Cannot verify the optimal solution."
				<< endl;
		exit(EXIT_FAILURE);
	}
	...
	if (env0.myrank == 0) {
		...
		if (ToulBar2::writeSolution) {
			...
			if (!ToulBar2::solutionFile) {
				cerr << "Could not open file " << ToulBar2::writeSolution
						<< endl;
				exit(EXIT_FAILURE);
			}
		}
		if (ToulBar2::uaieval) {
			...
			if (ToulBar2::uaieval
					&& (wcsppos = filename.rfind(".wcsp")) != string::npos)
			...
			ToulBar2::solution_uai_file = fopen(
					ToulBar2::solution_uai_filename.c_str(), "w");
			if (!ToulBar2::solution_uai_file) {
				cerr << "Could not open file "
						<< ToulBar2::solution_uai_filename << endl;
				exit(EXIT_FAILURE);
			}
			delete[] tmpPath;
			delete[] tmpFile;
...
//TODO: If --show_options then dump ToulBar2 object here
	...
	WeightedCSPSolver* solver = WeightedCSPSolver::makeWeightedCSPSolver(
			MAX_COST);
	...
	if (random_desc != NULL) {
		...
		if (strstr(random_desc, "binsub")) {
			...
			randomproblem = true;
			sscanf(random_desc, "binsub-%d-%d-%d-%d-%d-%d", &n, &m, &pn[0],
					&pn[1], &pn[2], &ToulBar2::seed);
			narities = 2;
		} else if (strstr(random_desc, "bin")) {
			randomproblem = true;
			sscanf(random_desc, "bin-%d-%d-%d-%d-%d", &n, &m, &pn[0], &pn[1],
					&ToulBar2::seed);
			narities = 2;
		} else if (strstr(random_desc, "tern")) {
			randomproblem = true;
			sscanf(random_desc, "tern-%d-%d-%d-%d-%d-%d", &n, &m, &pn[0],
					&pn[1], &pn[2], &ToulBar2::seed);
			narities = 3;
		...
		if (narities == 0) {
			cerr
					<< "Random problem generator with no cost functions! (no arity)"
					<< endl;
			exit(-1);
		}
	}
	if (strstr(strext.c_str(), ".bep")
			|| strstr((char*) strfile.c_str(), "bEpInstance"))
	...
	if (ToulBar2::incop_cmd.size() > 0 && ToulBar2::seed != 1
			&& ToulBar2::incop_cmd.find("0 1 ") == 0) {
	...
	try {
		if (randomproblem)
			solver->read_random(n, m, p, ToulBar2::seed, forceSubModular,
					randomglobal);
		else
			globalUb = solver->read_wcsp((char*) strfile.c_str());
		if (globalUb <= MIN_COST) {
			cerr << "Error: wrong initial primal bound (negative or zero)."
					<< endl;
			exit(1);
		}
		...
		if (certificate) {
			if (certificateFilename != NULL)
				solver->read_solution(certificateFilename,
						updateValueHeuristic);
			else
		...
		} else if (!certificate || certificateString != NULL
				|| ToulBar2::btdMode >= 2) {
#ifdef LINUX
	...
	if (ToulBar2::solutionFile != NULL) {
		if (ftruncate(fileno(ToulBar2::solutionFile),
				ftell(ToulBar2::solutionFile)))
			exit(EXIT_FAILURE);
		fclose(ToulBar2::solutionFile);
	}
	if (ToulBar2::solution_uai_file != NULL) {
		if (ftruncate(fileno(ToulBar2::solution_uai_file),
				ftell(ToulBar2::solution_uai_file)))
			exit(EXIT_FAILURE);
