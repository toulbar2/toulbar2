...
thread_local int Cluster::clusterCounter = 0;
...
thread_local WCSP* CmpVarStruct::wcsp = NULL;
...
{
    thread_local static Tuple s; // FIXME: unsafe???
...
void TreeDecomposition::setDuplicates(bool init)
{
    ...
    thread_local static unsigned int curCtr = 0;
    thread_local static int curElimBin = 0;
    thread_local static int curElimTern = 0;
