...
public:
    ...
    static bool GilmoreLawler; ///< \brief in preprocessing, singleton node consistency using Gilmore-Lawler lower bound instead of EAC-like greedy lower bound (command line option -S -glb)
