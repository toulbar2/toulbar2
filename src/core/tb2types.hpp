...
public:
    ...
    static bool negativeCostAuthorizedTemporarily; /// \brief allows negative costs temporarily (e.g. during pairwise consistency dedualization) internal usage only!
