...
public:
    ...
    TB2_THREAD_LOCAL static std::unique_ptr<DecomposableGlobalCostFunction> FactoryDGCF(string type, unsigned int _arity, int* _scope, istream& file, bool mult = true);
