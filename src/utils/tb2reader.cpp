...
void WCSP::read_qpbo(const char* fileName)
{
    ...
    Double multiplier = powl(10.0,(Double)ToulBar2::resolution); // warning! precision of costs depends on the chosen resolution but toulbar2 outputs costs as if it was always zero resolution.
...
void WCSP::read_opb(const char* fileName)
{
    ...
    bool opt = true;
    int opsize = 4;
    Double multiplier = powl(10.0,(Double)ToulBar2::resolution);
    ToulBar2::setCostMultiplier(multiplier);
...
void WCSP::read_lp(const char* fileName)
{
    ...
    Double multiplier = powl(10.0,(Double)min(ToulBar2::resolution, baryonyx::precision));
    ...
    for (auto& ctr : pb.greater_constraints) {
        ...
        nblinear++;
        Double multiplier = powl(10.0,(Double)min(ToulBar2::resolution, ctr.precision));
