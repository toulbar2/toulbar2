...
IF(WIN32)
  ...
  IF(LIBTB2)
    set_property(
      TARGET tb2
      PROPERTY COMPILE_DEFINITIONS NARYCHAR INT_COST DOUBLE_PROB WIN32 _DEBUG _WINDOWS WINDOWS)
  ENDIF(LIBTB2)
...
ELSE(WIN32)
  ...
  IF(TOULBAR2)
    ...
    set_property(
      TARGET tb2-archive
      PROPERTY COMPILE_DEFINITIONS NARYCHAR ${COST} ${XMLFLAG} LINUX ${boostflag} ${mpiflag} ${PROBABILITY})
    set_property(
      TARGET tb2-objects
      PROPERTY COMPILE_DEFINITIONS NARYCHAR ${COST} ${XMLFLAG} LINUX ${boostflag} ${mpiflag} ${PROBABILITY})
  ENDIF(TOULBAR2)
  ...
  IF(MENDELSOFT)
    set_property(
      TARGET mendelsoft
      PROPERTY COMPILE_DEFINITIONS NARYCHAR WCSPFORMATONLY ${COST} MENDELSOFT LINUX ${boostflag} ${mpiflag} ${PROBABILITY})
  ENDIF(MENDELSOFT)
  ...
  if(ILOG)
    set_property(
      TARGET iloglue
      PROPERTY COMPILE_DEFINITIONS NARYCHAR WCSPFORMATONLY INT_COST ILOGLUE IL_STD LINUX ${PROBABILITY})
  ENDIF(ILOG)
