...
IF(WIN32)
  ...
  IF(TOULBAR2)
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DWCSPFORMATONLY -DINT_COST -DDOUBLE_PROB -DWIN32 -D_DEBUG -D_WINDOWS -DWINDOWS")
    set_property(
      TARGET toulbar2${EXE}
  ...
  IF(MENDELSOFT)
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DWCSPFORMATONLY -DINT_COST -DDOUBLE_PROB -DMENDELSOFT -DWIN32 -D_DEBUG -D_WINDOWS -DWINDOWS")
    set_property(
  ...
  IF(LIBTB2)
    SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DINT_COST -DDOUBLE_PROB -DWIN32 -D_DEBUG -D_WINDOWS -DWINDOWS")
    set_property(
      TARGET tb2
