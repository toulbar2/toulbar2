...
bool Solver::solve()
{
    ...
    if (ToulBar2::isZ) {
        ...
        if (ToulBar2::uai) {
            ...
            ToulBar2::solution_uai_file << (ToulBar2::logZ + ToulBar2::markov_log) << endl;
